...
import { WrapperUploadFile, WrapperUploadFile1 } from "./style";
  ...
  return (
    <div>
        ...
        <Loding isLoading={isLoading}>
          ...
          >
            ...
            <Form.Item label="Image1" name="image1">
              <WrapperUploadFile1 onChange={handleOnchangeAvatar1}>
                <Button>Select File</Button>
                {stateProduct?.image1 && (
                  <img
      ...
      <DrawerComponent
        ...
        width="90%"
      >
        <Loding isLoading={isLoadingUpdate || isLoadingUpdated}>
          <Form
            name="basic"
            labelCol={{ span: 2 }}
            wrapperCol={{ span: 22 }}
          ...
          >
            ...
            <Form.Item
              ...
              name="image1"
              rules={[
                { required: true, message: "Please input your count image1!" },
              ]}
            >
              <WrapperUploadFile onChange={handleOnchangeAvatarDetails1}>
                <Button>Select File</Button>
